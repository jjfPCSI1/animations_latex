  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \ifthenelse{\iCOUNT > 6}{
      \draw [->,ultra thick] (1.2,0) node [below] {$A$} -- (1.2,0.7999999999999999) node [above] {$B$} ;
      }{}

      \draw [->,ultra thick] (3.0,0) node [below] {$A'$} -- (3.0,2.0) node [above] {$B'$} ;
      % Le rayon qui arrive // a l'axe optique
\ifthenelse{\iCOUNT > 1}{
    \draw [thick ,>>-] (-8,0.8) -- (0,0.8);
    \draw [thick , dashed] (0,0.8) -- (8,0.8);
    }{}
% ... arrive en passant par le foyer image
\ifthenelse{\iCOUNT > 0}{
    \draw [thick , dashed] (-8,-2.4) -- (0,0.8);
    \draw [thick ,->>] (0,0.8) -- (8,4.0);
    }{}
% Le rayon qui passe par le centre optique
\ifthenelse{\iCOUNT > 3}{
    \draw [thick ,>>-] (-6.0,-4.0) -- (0,0.0);
    \draw [thick , dashed] (0,0.0) -- (6.0,4.0);
    }{}
% ... n'est pas devie
\ifthenelse{\iCOUNT > 2}{
    \draw [thick , dashed] (-6.0,-4.0) -- (0,0.0);
    \draw [thick ,->>] (0,0.0) -- (6.0,4.0);
    }{}
