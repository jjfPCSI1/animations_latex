  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \filldraw [black] (0,0) circle (2pt) node [above right] {$O$} ;
      ...
      \draw [->,ultra thick] (-7.0,0) node [below] {$A$} -- (-7.0,2.0) node [above] {$B$} ;
      \ifthenelse{\iCOUNT > 6}{
      \draw [->,ultra thick] (-1.5555555555555556,0) node [below] {$A'$} -- (-1.5555555555555556,0.4444444444444445) node [above] {$B'$} ;
      }{}
...
\ifthenelse{\iCOUNT > 1}{
    \draw [thick , dashed] (-6.0,-4.0) -- (0,2.0);
    \draw [thick ,->>] (0,2.0) -- (2.0,4.0);
    }{}
% Le rayon qui passe par le centre optique
\ifthenelse{\iCOUNT > 2}{
    \draw [thick ,>>-] (-8,2.286) -- (0,0.0);
    \draw [thick , dashed] (0,0.0) -- (8,-2.286);
    }{}
% ... n'est pas devie
\ifthenelse{\iCOUNT > 3}{
    \draw [thick , dashed] (-8,2.286) -- (0,0.0);
    \draw [thick ,->>] (0,0.0) -- (8,-2.286);
    }{}
% Le rayon qui passe par le foyer objet
\ifthenelse{\iCOUNT > 4}{
    \draw [thick ,>>-] (-8,2.222) -- (0,0.444);
    \draw [thick , dashed] (0,0.444) -- (8,-1.333);
    }{}
% ... ressort // a l'axe optique
\ifthenelse{\iCOUNT > 5}{
    \draw [thick , dashed] (-8,0.444) -- (0,0.444);
    \draw [thick ,->>] (0,0.444) -- (8,0.444);
    }{}
