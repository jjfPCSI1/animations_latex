  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \filldraw [black] (0,0) circle (2pt) node [above right] {$O$} ;
      ...
      \draw [->,ultra thick] (-1.0,0) node [below] {$A$} -- (-1.0,2.0) node [above] {$B$} ;
      \ifthenelse{\iCOUNT > 6}{
      \draw [->,ultra thick] (-0.6666666666666666,0) node [below] {$A'$} -- (-0.6666666666666666,1.3333333333333333) node [above] {$B'$} ;
      }{}
...
\ifthenelse{\iCOUNT > 2}{
    \draw [thick ,>>-] (-2.0,4.0) -- (0,0.0);
    \draw [thick , dashed] (0,0.0) -- (2.0,-4.0);
    }{}
% ... n'est pas devie
\ifthenelse{\iCOUNT > 3}{
    \draw [thick , dashed] (-2.0,4.0) -- (0,0.0);
    \draw [thick ,->>] (0,0.0) -- (2.0,-4.0);
    }{}
% Le rayon qui passe par le foyer objet
\ifthenelse{\iCOUNT > 4}{
    \draw [thick ,>>-] (-4.0,4.0) -- (0,1.333);
    \draw [thick , dashed] (0,1.333) -- (8,-4.0);
    }{}
% ... ressort // a l'axe optique
\ifthenelse{\iCOUNT > 5}{
    \draw [thick , dashed] (-8,1.333) -- (0,1.333);
    \draw [thick ,->>] (0,1.333) -- (8,1.333);
    }{}
