  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \filldraw [black] (0,0) circle (2pt) node [above right] {$O$} ;
      ...
      \draw [->,ultra thick] (-5.0,0) node [below] {$A$} -- (-5.0,2.0) node [above] {$B$} ;
      \ifthenelse{\iCOUNT > 6}{
      \draw [->,ultra thick] (-1.4285714285714286,0) node [below] {$A'$} -- (-1.4285714285714286,0.5714285714285714) node [above] {$B'$} ;
      }{}
...
\ifthenelse{\iCOUNT > 2}{
    \draw [thick ,>>-] (-8,3.2) -- (0,0.0);
    \draw [thick , dashed] (0,0.0) -- (8,-3.2);
    }{}
% ... n'est pas devie
\ifthenelse{\iCOUNT > 3}{
    \draw [thick , dashed] (-8,3.2) -- (0,0.0);
    \draw [thick ,->>] (0,0.0) -- (8,-3.2);
    }{}
% Le rayon qui passe par le foyer objet
\ifthenelse{\iCOUNT > 4}{
    \draw [thick ,>>-] (-8,2.857) -- (0,0.571);
    \draw [thick , dashed] (0,0.571) -- (8,-1.714);
    }{}
% ... ressort // a l'axe optique
\ifthenelse{\iCOUNT > 5}{
    \draw [thick , dashed] (-8,0.571) -- (0,0.571);
    \draw [thick ,->>] (0,0.571) -- (8,0.571);
    }{}
