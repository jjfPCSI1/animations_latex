  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \ifthenelse{\iCOUNT > 6}{
      \draw [->,ultra thick] (6.0,0) node [above] {$A$} -- (6.0,-4.0) node [below] {$B$} ;
      }{}

      \draw [->,ultra thick] (-3.0,0) node [below] {$A'$} -- (-3.0,2.0) node [above] {$B'$} ;
      % Le rayon qui arrive // a l'axe optique
\ifthenelse{\iCOUNT > 1}{
    \draw [thick ,>>-] (-8,-4.0) -- (0,-4.0);
    \draw [thick , dashed] (0,-4.0) -- (8,-4.0);
    }{}
% ... arrive en passant par le foyer image
\ifthenelse{\iCOUNT > 0}{
    \draw [thick , dashed] (-4.0,4.0) -- (0,-4.0);
    \draw [thick ,->>] (0,-4.0) -- (0.0,-4.0);
    }{}
