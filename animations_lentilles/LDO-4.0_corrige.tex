  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \filldraw [black] (0,0) circle (2pt) node [above right] {$O$} ;
      ...
      \ifthenelse{\iCOUNT > 6}{
      \draw [->,ultra thick] (-1.3333333333333333,0) node [below] {$A'$} -- (-1.3333333333333333,0.6666666666666666) node [above] {$B'$} ;
      }{}
...
\ifthenelse{\iCOUNT > 4}{
    \draw [thick ,>>-] (-8,3.333) -- (0,0.667);
    \draw [thick , dashed] (0,0.667) -- (8,-2.0);
    }{}
% ... ressort // a l'axe optique
\ifthenelse{\iCOUNT > 5}{
    \draw [thick , dashed] (-8,0.667) -- (0,0.667);
    \draw [thick ,->>] (0,0.667) -- (8,0.667);
    }{}
